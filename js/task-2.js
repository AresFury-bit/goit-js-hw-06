...
//  Функція очікує один параметр: days — масив обєктів.Кожен обєкт описує день тижня та кількість калорій calories, спожитих спортсменом,
...
function calcAverageCalories(days) {
 let caloriesAllDay = 0;
    let day = 0;
    for (const calori of days) {
        caloriesAllDay += calori.calories;
        day++;
    }
